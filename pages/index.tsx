		...
		<Page className="flex flex-col gap-8">
			...
			<section className="max-w-4xl mx-auto w-full bg-blue-50 border border-blue-200 rounded-lg p-6">
				...
				<div className="space-y-3 text-gray-700">
					<p>
						<strong>1. Setup Environment:</strong> Configure your{" "}
					...
					<ul className="list-disc list-inside ml-4 space-y-1">
						...
						<li>
							...
							- Your Hashnode API key (get from{" "}
							<a
					...
					<p>
						<strong>2. Fill the Form:</strong> Enter your password, article
						title, content (in Markdown), and comma-separated tags
					</p>
					<p>
						<strong>3. Select Platforms:</strong> Choose which platforms to
						publish to
					</p>
					<p>
						<strong>4. Publish:</strong> Click the publish button and wait for
						results
					</p>
				</div>
			</section>
			...
			<section className="max-w-4xl mx-auto w-full bg-gray-50 border border-gray-200 rounded-lg p-6">
				...
				<p className="mb-3 text-gray-700">
					You can also publish programmatically using the API:
				</p>
						...
						<div className="space-y-2">
							<label className="flex items-center space-x-2">
								<input
									...
									onChange={(e) =>
										setPlatforms({ ...platforms, devto: e.target.checked })
									}
									className="rounded"
								/>
							...
							<label className="flex items-center space-x-2">
								<input
									...
									onChange={(e) =>
										setPlatforms({ ...platforms, hashnode: e.target.checked })
									}
									className="rounded"
								/>
			...
			<section className="max-w-4xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-6">
				<div className="p-6 border rounded-lg bg-white">
					...
					<p className="text-gray-600">
						Password-protected API with environment-based credentials
					</p>
				</div>
				<div className="p-6 border rounded-lg bg-white">
